...
class Processo(models.Model):
    ...
    valor_risco = models.DecimalField(max_digits=10, decimal_places=2, default=0.0)
    risco = models.CharField(max_length=100, null=True)
    total_pago = models.DecimalField(max_digits=10, decimal_places=2, default=0.0)
    inss_empresa = models.DecimalField(max_digits=10, decimal_places=2, default=0.0)
    honorarios = models.DecimalField(max_digits=10, decimal_places=2, default=0.0)
    custas_processuais = models.DecimalField(max_digits=10, decimal_places=2, default=0.0)
    ...
    ult_desdobramento = models.DateField(null=True)
    ...
    autor_contumaz = models.BooleanField(default=False)
    motivo_desligamento = models.TextField(null=True)
    cargo = models.CharField(max_length=100, null=True)
    terceiro_interessado = models.BooleanField(default=False)
    terceiro = models.CharField(max_length=100, null=True)
    terceiro_prestador = models.BooleanField(default=False)
    ...
    tribunal = models.CharField(max_length=100, null=True)  # Campo adicionado para o Tribunal
    ...
    valor_risco_remoto = models.DecimalField(max_digits=10, decimal_places=2, default=0.0)
